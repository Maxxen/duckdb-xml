...
#### Main build
# For regular CLI build, we link the xml extension directly into the DuckDB executable
...
#### Client tests
DEBUG_EXT_PATH='$(PROJ_DIR)build/debug/extension/xml/xml.duckdb_extension'
RELEASE_EXT_PATH='$(PROJ_DIR)build/release/extension/xml/xml.duckdb_extension'
...
wasm_mvp:
	...
	cd build/wasm_mvp/extension/${EXTENSION_NAME} && emcc $f -sSIDE_MODULE=1 -o ../../${EXTENSION_NAME}.duckdb_extension.wasm -O3 ${EXTENSION_NAME}.duckdb_extension $(WASM_LINK_TIME_FLAGS)
...
wasm_eh:
	...
	cd build/wasm_eh/extension/${EXTENSION_NAME} && emcc $f -sSIDE_MODULE=1 -o ../../${EXTENSION_NAME}.duckdb_extension.wasm -O3 ${EXTENSION_NAME}.duckdb_extension $(WASM_LINK_TIME_FLAGS)
...
wasm_threads:
	...
	cd build/wasm_threads/extension/${EXTENSION_NAME} && emcc $f -sSIDE_MODULE=1 -o ../../${EXTENSION_NAME}.duckdb_extension.wasm -O3 ${EXTENSION_NAME}.duckdb_extension $(WASM_LINK_TIME_FLAGS)