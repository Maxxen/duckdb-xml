...
public:
	...
	XMLParseResult Parse(const char *buffer, size_t len, bool is_final) {
		...
		switch(status) {
			...
			case XML_STATUS_SUSPENDED: return XMLParseResult::SUSPENDED;
			case XML_STATUS_OK: return XMLParseResult::OK;
			default: throw InternalException("Unknown XML parsing status");
		}
	}
