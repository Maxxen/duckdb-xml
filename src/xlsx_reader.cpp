...
static unique_ptr<FunctionData> Bind(ClientContext &context, TableFunctionBindInput &input,
	...
	sniffer.header_mode = has_first_row_is_header ? (first_row_is_header ? HeaderMode::ALWAYS : HeaderMode::NEVER) : HeaderMode::AUTO;
...
public:
	explicit DenseStringTableParser(vector<string> &string_table_p)
...
public:
	...
	explicit XLSSheetReader(ClientContext &ctx, vector<string> &string_table_p, idx_t column_count_p) : string_table(string_table_p) {
